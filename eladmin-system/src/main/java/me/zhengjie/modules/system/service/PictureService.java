...
public interface PictureService {
    ...
    */
    List<PictureDto> queryAll(PictureQueryCriteria criteria);
     ...
     * @return PictureDto
     */
    PictureDto findById(Integer pictureId);
    ...
    * @return PictureDto
    */
    PictureDto create(Picture resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(Picture resources);
