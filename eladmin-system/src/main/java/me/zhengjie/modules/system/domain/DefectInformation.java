...
@Entity
@Data
@Table(name="defect_information")
public class DefectInformation implements Serializable {
    ...
    @ApiModelProperty(value = "检测报告_查看/下载")
    private String detectionSummary;

    @Column(name = "eliminate_defects")
    @ApiModelProperty(value = "消缺情况_上传/下载/查看")
    ...
    public void copy(DefectInformation source){
