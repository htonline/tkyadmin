...
<script>
import crudDetectionInformation from '@/api/detectionInformation'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'api/detection_information', url: 'api/detectionInformation', idField: 'detectionId', sort: 'detectionId,desc', crudMethod: { ...crudDetectionInformation }})
  },
  data() {
    return {
      permission: {
